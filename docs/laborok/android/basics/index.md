...
Ez a labor azoknak szól, akiknek teljesen új az Android fejlesztés és a fejlesztőkörnyezet. Javasolt otthon önállóan végignézni.
...
1. A projekt neve legyen `HelloWorld`, a kezdő package pedig `hu.bme.aut.android.helloworld`.
